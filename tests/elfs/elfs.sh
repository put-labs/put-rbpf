...
#LLVM_DIR=../../../solana/sdk/sbf/dependencies/platform-tools/llvm/bin/
LLVM_DIR=/app/orca/solana/new/solana/target/release/sdk/sbf/dependencies/platform-tools/llvm/bin/

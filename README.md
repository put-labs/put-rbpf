...
This crate is available from [crates.io](https://crates.io/crates/put_rbpf),
...
```toml
[dependencies]
put_rbpf = { git = "https://github.com/put-labs/rbpf", branch = "main" }
```
...
```toml
[dependencies]
put_rbpf = { path = "path/to/put_rbpf" }
```
...
here](https://docs.rs/put_rbpf/), automatically generated from the
[crates.io](https://crates.io/crates/put_rbpf)
